...
INSERT INTO shop VALUES (0,'Водяная трубка',10000,'Инструменты','Напиток','Трубка для добычи воды из дерева',null,40);
INSERT INTO shop VALUES (1,'Булочки',20000,'Еда','Еда','Корзинка булочек',null,40);
INSERT INTO shop VALUES (2,'Мазь от укусов',70000,'Лекарства','Лекарство','Небольшая балочка мази, спасает от укусов ос-убийц',null,40);
INSERT INTO shop VALUES (3,'Бутылка воды',50000,'Напиток','Напиток','Маленькая бутылка воды',null,40);
INSERT INTO shop VALUES (4,'Мазь для ожогов',70000,'Лекарства','Лекарство','Небольшая балочка мази, спасает от ожогов',null,40);
INSERT INTO shop VALUES (5,'Нож',10000,'Инструменты','Еда','Раскладной ножик',null,40);
INSERT INTO shop VALUES (6,'Сетка',10000,'Другое','Еда','Сетка для ловли рыбы',null,40);
INSERT INTO shop VALUES (7,'Суп',20000,'Еда','Еда','Маленькая чашка с супом',null,40);
INSERT INTO shop VALUES (8,'Стрелы',50000,'Инструменты','Еда','6 стрел',null,40);
INSERT INTO shop VALUES (9,'Фляга',30000,'Другое','Напиток','Небольшая фляга для воды',null,40);
INSERT INTO shop VALUES (10,'Йод',30000,'Лекарства','Лекарство','',null,40);
