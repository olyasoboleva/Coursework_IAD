...
INSERT INTO shop VALUES (0,'Водяная трубка',10000,'Инструменты','Трубка для добычи воды из дерева',null,40);
INSERT INTO shop VALUES (1,'Булочки',20000,'Еда','Корзинка булочек',null,40);
INSERT INTO shop VALUES (2,'Мазь от укусов',70000,'Лекарства','Небольшая балочка мази, спасает от укусов ос-убийц',null,40);
INSERT INTO shop VALUES (3,'Бутылка воды',50000,'Напиток','Маленькая бутылка воды',null,40);
INSERT INTO shop VALUES (4,'Мазь для ожогов',70000,'Лекарства','Небольшая балочка мази, спасает от ожогов',null,40);
INSERT INTO shop VALUES (5,'Нож',10000,'Инструменты','',null,40);
INSERT INTO shop VALUES (6,'Сетка',10000,'Другое','Сетка для ловли рыбы',null,40);
